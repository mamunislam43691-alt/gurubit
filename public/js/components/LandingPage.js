...
<<<<<<< HEAD
                        ...
                        <div class="flex items-center gap-2 sm:gap-3 shrink-0">
                            ...
                            <button id="navSignupBtn" class="neon-btn px-3 sm:px-5 py-2 sm:py-2.5 text-xs uppercase tracking-widest whitespace-nowrap">Sign up</button>
                        </div>
                    </div>
                </nav>

                <!-- Hero -->
                <section class="relative z-10 pt-24 pb-16 lg:pt-40 lg:pb-28 px-4 landing-3d-scene">
                    <div class="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                        <div class="text-center lg:text-left">
                            <div class="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full border border-primary/30 bg-primary/5 mb-5 badge-3d reveal-up">
                                <span class="w-2 h-2 bg-green-400 rounded-full animate-pulse"></span>
                                <span class="text-[10px] sm:text-xs font-black text-primary uppercase tracking-widest">100% Free · No Credit Card</span>
                            </div>
                            <h1 class="text-3xl sm:text-4xl lg:text-6xl font-black leading-[1.1] mb-5 uppercase tracking-tight reveal-up delay-1">
                                Online Phone Numbers For<br><span class="shimmer-text">SMS Verification</span>
                            </h1>
                            <p class="text-gray-400 text-sm sm:text-base leading-relaxed mb-8 max-w-xl mx-auto lg:mx-0 reveal-up delay-2">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start reveal-up delay-3">
                                <button id="heroGetStartedBtn" class="neon-btn px-8 py-3.5 text-sm uppercase tracking-[0.15em] inline-flex items-center justify-center gap-2 badge-3d">
                                    Get Started Free <i class="fas fa-arrow-right text-xs"></i>
                                </button>
                                <a href="/live-feed" class="px-6 py-3.5 text-sm font-bold uppercase tracking-widest border border-white/15 rounded-xl text-gray-300 hover:border-primary/50 hover:text-primary transition-all inline-flex items-center justify-center gap-2">
                                    <i class="fas fa-satellite-dish text-xs"></i> Live Feed
                                </a>
                            </div>
                            <div class="flex items-center gap-6 sm:gap-8 mt-8 justify-center lg:justify-start reveal-up delay-4">
                                <div class="text-center"><p class="text-xl sm:text-2xl font-black text-primary neon-text">50+</p><p class="text-[10px] text-gray-500 uppercase tracking-widest">Countries</p></div>
